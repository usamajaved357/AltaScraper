 ...
 * Only m.media-amazon.com and images-*.ssl-images-amazon.com URLs are touched,
 * and only when they have no size directive already. An eBay picture, a Google
 * Drive link, a data: URI or an Amazon URL somebody has already sized is
 * returned EXACTLY as it came in -- inventing a size parameter for a CDN that
 * does not understand it turns a working image into a broken one.
 */
