...
function navTo(sec){
  ...
  ["imagerefs","setup","generate","miles","sales","traffic","hourly","ppc","inventory","sync","monitor","sourcing","orders","returns","weekly","aiusage","finance","variations","sellerimport"].forEach(s=>{
